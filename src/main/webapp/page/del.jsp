...
<DIV id=logo><IMG src="../../images/logo.gif"></DIV>
  ...
  <LABEL class="ui-green searchs"><a href="/page/house/selectByUsersId?isdel=0" title="">返回</a></LABEL>
...
<TABLE class=house-list>
  ...
  <TR>
    ...
    <TD class=house-price><LABEL class=ui-green><INPUT value="恢复" type=button name=search onclick="delOne(this,${house.id})"></LABEL></TD>
  </TR>
  </c:forEach>
  </TBODY>
</TABLE></DIV>
...
<UL>
  <c:forEach begin="1" end="${pageInfo.pages}" step="1" var="i">
    <LI class=current>
      <A id=widget_338868862 href="/page/house/selectByUsersId?page=${i}&isdel=1"
...
<script type="text/javascript">
    function delOne(obj,id) {
        if (confirm('确定恢复吗？')){
            location.href='/page/house/deleteOne?isdel=0&id='+id;
            //取到tr标签
            //var tr=$(obj).parents('tr');
            //tr.remove();
            //$.post('/page/house/deleteOne',{'id':id,'isdel':0},function (data) {
            //    if (data.result>0){
                    //删除tr
            //        tr.remove();
            //    }
